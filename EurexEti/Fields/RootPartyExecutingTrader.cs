...
/// <summary>
///  Root Party Executing Trader: Optional Fixed Length Space Filled String Field
/// </summary>
...
public static class RootPartyExecutingTrader
{
    ...
    {
        return new string ((sbyte*)pointer, offset, RootPartyExecutingTrader.Length).Trim();
    }
}
