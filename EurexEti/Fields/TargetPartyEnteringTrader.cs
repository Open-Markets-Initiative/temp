...
{
    /// <summary>
    ///  Target Party Entering Trader: Optional Fixed Length String Field
    /// </summary>

    public sealed class TargetPartyEnteringTrader
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, TargetPartyEnteringTrader.Length).Trim('\0');
        }
    }
}