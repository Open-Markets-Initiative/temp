...
/// <summary>
///  Party Entering Trader: Optional Fixed Length Space Filled String Field
/// </summary>

public static class PartyEnteringTrader
{
    /// <summary>
    ...
    {
        return new string ((sbyte*)pointer, offset, PartyEnteringTrader.Length).Trim();
    }
}
