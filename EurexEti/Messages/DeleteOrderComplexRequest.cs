...
{
    /// <summary>
    ///  Delete Order Complex Request Message Methods
    /// </summary>

    public partial class DeleteOrderComplexRequest
    {
        /// <summary>
        ///  Eti Identifier for Delete Order Complex Request
        /// </summary>
        public const string Identifier = "Delete Order Complex Request";

        /// <summary>
        ///  Encode Delete Order Complex Request Message
        /// </summary>
        public static unsafe void Encode(FixMessage message, byte* pointer, int offset, int length, out int current)
        {
            ...
            TemplateId.Encode(pointer, current, TemplateId.DeleteOrderComplexRequest, out current);
        ...
        /// <summary>
        ///  Decode Delete Order Complex Request Message
        /// </summary>
        public static unsafe FixErrorCode Decode(ref FixMessage message, byte* pointer, int offset, out int current)
        {
            ...
            message.msgType = DeleteOrderComplexRequest.Identifier;
