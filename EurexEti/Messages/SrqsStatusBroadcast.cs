...
{
    /// <summary>
    ///  Srqs Status Broadcast Message Methods
    /// </summary>

    public partial class SrqsStatusBroadcast
    {
        /// <summary>
        ///  Eti Identifier for Srqs Status Broadcast
        /// </summary>
        public const string Identifier = "Srqs Status Broadcast";

        /// <summary>
        ///  Encode Srqs Status Broadcast Message
        /// </summary>
        public static unsafe void Encode(FixMessage message, byte* pointer, int offset, int length, out int current)
        {
            ...
            TemplateId.Encode(pointer, current, TemplateId.SrqsStatusBroadcast, out current);
        ...
        /// <summary>
        ///  Decode Srqs Status Broadcast Message
        /// </summary>
        public static unsafe FixErrorCode Decode(ref FixMessage message, byte* pointer, int offset, out int current)
        {
            ...
            message.msgType = SrqsStatusBroadcast.Identifier;
