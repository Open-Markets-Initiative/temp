...
{
    /// <summary>
    ///  Party Order Origination Trader: Optional Fixed Length Space Filled String Field
    /// </summary>
    ...
    public static class PartyOrderOriginationTrader
    {
        ...
        {
            return new string ((sbyte*)pointer, offset, PartyOrderOriginationTrader.Length).Trim();
        }
    }
}