...
{
    /// <summary>
    ///  Requesting Party Entering Firm: Optional Fixed Length Space Filled String Field
    /// </summary>

    public static class RequestingPartyEnteringFirm
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, RequestingPartyEnteringFirm.Length).Trim();
        }
    }
}