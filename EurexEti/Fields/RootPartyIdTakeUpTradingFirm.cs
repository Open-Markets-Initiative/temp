...
{
    /// <summary>
    ///  Root Party Id Take Up Trading Firm: Optional Fixed Length String Field
    /// </summary>

    public sealed class RootPartyIdTakeUpTradingFirm
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, RootPartyIdTakeUpTradingFirm.Length).Trim('\0');
        }
    }
}