...
{
    /// <summary>
    ///  Network Msg Id: Optional Fixed Length Space Filled String Field
    /// </summary>

    public static class NetworkMsgId
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, NetworkMsgId.Length).Trim();
        }
    }
}