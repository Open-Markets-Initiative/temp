...
{
    /// <summary>
    ///  Party Detail Executing Trader: Optional Fixed Length String Field
    /// </summary>

    public sealed class PartyDetailExecutingTrader
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, PartyDetailExecutingTrader.Length).Trim('\0');
        }
    }
}