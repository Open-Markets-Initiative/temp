...
/// <summary>
///  Party Id Position Account: Optional Fixed Length Space Filled String Field
/// </summary>

public static class PartyIdPositionAccount
{
    /// <summary>
    ...
    {
        return new string ((sbyte*)pointer, offset, PartyIdPositionAccount.Length).Trim();
    }
}
