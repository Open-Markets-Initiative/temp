...
/// <summary>
///  Party Id Beneficiary: Optional Fixed Length Space Filled String Field
/// </summary>

public static class PartyIdBeneficiary
{
    /// <summary>
    ...
    {
        return new string ((sbyte*)pointer, offset, PartyIdBeneficiary.Length).Trim();
    }
}
