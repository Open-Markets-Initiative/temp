...
namespace Eurex.EtiDerivatives.v130
{
    ...
    public partial static class QuoteLegExecGrpComp
    {
        /// <summary>
        ...
        /// </summary>
        public static unsafe void Encode(FixMessage message, byte* pointer, int offset, int quoteLegExecGrpComp, out int current)
        {
            current = offset;
