...
{
    /// <summary>
    ///  Modify Order Request Message Methods
    /// </summary>

    public static partial class ModifyOrderRequest
    {
        /// <summary>
        ///  Eti Identifier for Modify Order Request
        /// </summary>
        public const string Identifier = "10140";

        /// <summary>
        ///  Encode Modify Order Request Message
        /// </summary>
        public static unsafe void Encode(FixMessage message, byte* pointer, int offset, int length, out int current)
        {
            ...
            TemplateId.Encode(pointer, current, TemplateId.ModifyOrderRequest, out current);
        ...
        /// <summary>
        ///  Decode Modify Order Request Message
        /// </summary>
        public static unsafe FixErrorCode Decode(ref FixMessage message, byte* pointer, int offset, out int current)
        {
            ...
            message.msgType = ModifyOrderRequest.Identifier;
