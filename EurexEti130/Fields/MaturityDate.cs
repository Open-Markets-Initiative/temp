...
/// <summary>
///  Maturity Date: Optional 4 Byte Fixed Width Integer
/// </summary>
...
public static class MaturityDate
{
    ...
    /// <summary>
    ///  Check available length and set Maturity Date to no value
    /// </summary>
    ...
    /// <summary>
    ///  Set Maturity Date to no value and update index
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
