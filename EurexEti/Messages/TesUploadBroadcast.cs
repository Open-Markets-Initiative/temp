...
namespace Eurex.EtiDerivatives.v130
{
    ...
    public partial class TesUploadBroadcast
    {
        ...
        public static unsafe void Encode(FixMessage message, byte* pointer, int offset, int length, out int current)
        {
            ...
            var isSideAllocExtGrpComp = message.TryGetGroup(NoSideAllocs.FixTag, out var sideAllocExtGrpComp) && SideAllocExtGrpComp.sectionList.Length > 0;
            if (isSideAllocExtGrpComp)
            {
                var noSideAllocs = (byte)sideAllocExtGrpComp.sectionList.Length;
