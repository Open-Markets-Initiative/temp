namespace SRFixBase
{
    ...
    {
        /// <summary>
        ///  Eurex Derivatives Eti T7 v13 0 New Basket Instrmt Match Side Grp Comp
        /// </summary>
        public static readonly FixComponentBlock NewBasketInstrmtMatchSideGrpComp = new FixComponentBlock
        {
            Tag = Eurex.EtiDerivatives.v130.NewBasketInstrmtMatchSideGrpComp.FixTag,
