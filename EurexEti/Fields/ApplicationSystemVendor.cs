...
{
    /// <summary>
    ///  Application System Vendor: Optional Fixed Length Space Filled String Field
    /// </summary>

    public static class ApplicationSystemVendor
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, ApplicationSystemVendor.Length).Trim();
        }
    }
}