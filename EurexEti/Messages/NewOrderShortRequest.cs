...
namespace Eurex.EtiDerivatives.v121
{
    ...
    public partial class NewOrderShortRequest
    {
        /// <summary>
        ///  Eti Identifier for New Order Short Request
        /// </summary>
        public const string Identifier = "New Order Short Request";

        /// <summary>
        ///  Encode New Order Short Request Message
        /// </summary>
        public static unsafe void Encode(FixMessage message, byte* pointer, int offset, int length, out int current)
        {
            ...
            TemplateId.Encode(pointer, current, TemplateId.NewOrderShortRequest, out current);
        ...
        /// <summary>
        ///  Decode New Order Short Request Message
        /// </summary>
        public static unsafe FixErrorCode Decode(ref FixMessage message, byte* pointer, int offset, out int current)
        {
            ...
            message.msgType = NewOrderShortRequest.Identifier;
