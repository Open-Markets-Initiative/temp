...
/// <summary>
///  Underlying Price Stip Value: 8 Byte Fixed Width Nullable Integer with 8 Decimal Place Precision
/// </summary>

public static class UnderlyingPriceStipValue
{
    /// <summary>
    ...
    /// <summary>
    ///  Null value for Underlying Price Stip Value
    /// </summary>
    ...
    /// <summary>
    ///  Check available length and set Underlying Price Stip Value to no value
    /// </summary>
    ...
    /// <summary>
    ///  Set Underlying Price Stip Value to no value and update index
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    ///  Set Underlying Price Stip Value to no value
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
