...
{
    /// <summary>
    ///  Party Executing Trader: Optional Fixed Length String Field
    /// </summary>

    public sealed class PartyExecutingTrader
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, PartyExecutingTrader.Length).Trim('\0');
        }
    }
}