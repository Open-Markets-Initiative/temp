...
{
    /// <summary>
    ///  Party Detail Executing Unit: Optional Fixed Length Space Filled String Field
    /// </summary>

    public static class PartyDetailExecutingUnit
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, PartyDetailExecutingUnit.Length).Trim();
        }
    }
}