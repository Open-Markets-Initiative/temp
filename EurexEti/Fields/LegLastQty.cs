...
{
    /// <summary>
    ///  Leg Last Qty: 8 Byte Fixed Width Nullable Integer with 4 Decimal Place Precision
    /// </summary>

    public static class LegLastQty
    {
        /// <summary>
        ///  Fix Tag for Leg Last Qty
        /// </summary>
        public const ushort FixTag = 1418;
        ...
        /// <summary>
        ///  Check available length and set Leg Last Qty to no value
        /// </summary>
        ...
        /// <summary>
        ///  Set Leg Last Qty to no value and update index
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
