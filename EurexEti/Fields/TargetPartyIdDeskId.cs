...
{
    /// <summary>
    ///  Target Party Id Desk Id: Optional Fixed Length Space Filled String Field
    /// </summary>

    public static class TargetPartyIdDeskId
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, TargetPartyIdDeskId.Length).Trim();
        }
    }
}