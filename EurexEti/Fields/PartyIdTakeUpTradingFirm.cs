...
{
    /// <summary>
    ///  Party Id Take Up Trading Firm: Optional Fixed Length Space Filled String Field
    /// </summary>

    public static class PartyIdTakeUpTradingFirm
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, PartyIdTakeUpTradingFirm.Length).Trim();
        }
    }
}