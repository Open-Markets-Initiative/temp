...
/// <summary>
///  Margin Based Risk Limit Short: 8 Byte Fixed Width Nullable Integer with 8 Decimal Place Precision
/// </summary>

public static class MarginBasedRiskLimitShort
{
    /// <summary>
    ///  Fix Tag for Margin Based Risk Limit Short
    /// </summary>
    public const ushort FixTag = 37531;
    ...
    /// <summary>
    ///  Null value for Margin Based Risk Limit Short
    /// </summary>
    ...
    /// <summary>
    ///  Check available length and set Margin Based Risk Limit Short to no value
    /// </summary>
    ...
    /// <summary>
    ///  Set Margin Based Risk Limit Short to no value and update index
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    ///  Set Margin Based Risk Limit Short to no value
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
