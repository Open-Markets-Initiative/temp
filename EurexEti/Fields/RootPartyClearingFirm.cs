...
{
    /// <summary>
    ///  Root Party Clearing Firm: Optional Fixed Length String Field
    /// </summary>

    public sealed class RootPartyClearingFirm
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, RootPartyClearingFirm.Length).Trim('\0');
        }
    }
}