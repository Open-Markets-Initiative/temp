...
{
    /// <summary>
    ///  Application System Name: Optional Fixed Length Space Filled String Field
    /// </summary>

    public static class ApplicationSystemName
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, ApplicationSystemName.Length).Trim();
        }
    }
}