...
{
    /// <summary>
    ///  Root Party Id Order Origination Firm: Optional Fixed Length String Field
    /// </summary>

    public sealed class RootPartyIdOrderOriginationFirm
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, RootPartyIdOrderOriginationFirm.Length).Trim('\0');
        }
    }
}