...
{
    /// <summary>
    ///  Reversal Reason Text: Optional Fixed Length Space Filled String Field
    /// </summary>

    public static class ReversalReasonText
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, ReversalReasonText.Length).Trim();
        }
    }
}