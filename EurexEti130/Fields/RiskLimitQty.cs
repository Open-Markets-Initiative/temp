...
/// <summary>
///  Risk Limit Qty: 8 Byte Fixed Width Nullable Integer with 4 Decimal Place Precision
/// </summary>

public static class RiskLimitQty
{
    /// <summary>
    ...
    /// <summary>
    ///  Check available length and set Risk Limit Qty to no value
    /// </summary>
    ...
    /// <summary>
    ///  Set Risk Limit Qty to no value and update index
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    ///  Set Risk Limit Qty to no value
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
