...
/// <summary>
///  Root Party Entering Trader: Optional Fixed Length Space Filled String Field
/// </summary>
...
public static class RootPartyEnteringTrader
{
    ...
    /// </summary>
    public const ushort FixTag = 22436;
    ...
    {
        return new string ((sbyte*)pointer, offset, RootPartyEnteringTrader.Length).Trim();
    }
}
