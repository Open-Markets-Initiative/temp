...
/// <summary>
///  Party Id Order Origination Firm: Optional Fixed Length Space Filled String Field
/// </summary>

public static class PartyIdOrderOriginationFirm
{
    /// <summary>
    ...
    {
        return new string ((sbyte*)pointer, offset, PartyIdOrderOriginationFirm.Length).Trim();
    }
}
