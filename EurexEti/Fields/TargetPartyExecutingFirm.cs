...
{
    /// <summary>
    ///  Target Party Executing Firm: Optional Fixed Length String Field
    /// </summary>

    public sealed class TargetPartyExecutingFirm
    {
        /// <summary>
        ...
        {
            return new string ((sbyte*)pointer, offset, TargetPartyExecutingFirm.Length).Trim('\0');
        }
    }
}