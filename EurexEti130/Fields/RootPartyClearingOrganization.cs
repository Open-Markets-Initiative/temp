...
/// <summary>
///  Root Party Clearing Organization: Optional Fixed Length Space Filled String Field
/// </summary>

public static class RootPartyClearingOrganization
{
    /// <summary>
    ...
    {
        return new string ((sbyte*)pointer, offset, RootPartyClearingOrganization.Length).Trim();
    }
}
