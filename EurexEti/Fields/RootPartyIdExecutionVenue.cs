...
/// <summary>
///  Root Party Id Execution Venue: Optional Fixed Length Space Filled String Field
/// </summary>
...
public static class RootPartyIdExecutionVenue
{
    ...
    {
        return new string ((sbyte*)pointer, offset, RootPartyIdExecutionVenue.Length).Trim();
    }
}
