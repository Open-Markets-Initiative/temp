...
{
    /// <summary>
    ///  Requesting Party Clearing Firm: Optional Fixed Length Space Filled String Field
    /// </summary>
    ...
    public static class RequestingPartyClearingFirm
    {
        ...
        {
            return new string ((sbyte*)pointer, offset, RequestingPartyClearingFirm.Length).Trim();
        }
    }
}