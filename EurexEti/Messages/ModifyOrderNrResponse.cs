...
namespace Eurex.EtiDerivatives.v121
{
    ...
    public partial class ModifyOrderNrResponse
    {
        ...
        /// </summary>
        public const string Identifier = "Modify Order Nr Response";

        /// <summary>
        ///  Encode Modify Order Nr Response Message
        /// </summary>
        public static unsafe void Encode(FixMessage message, byte* pointer, int offset, int length, out int current)
        {
            ...
            TemplateId.Encode(pointer, current, TemplateId.ModifyOrderNrResponse, out current);
        ...
        /// <summary>
        ///  Decode Modify Order Nr Response Message
        /// </summary>
        public static unsafe FixErrorCode Decode(ref FixMessage message, byte* pointer, int offset, out int current)
        {
            ...
            message.msgType = ModifyOrderNrResponse.Identifier;
