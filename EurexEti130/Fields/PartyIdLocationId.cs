...
/// <summary>
///  Party Id Location Id: Optional Fixed Length Space Filled String Field
/// </summary>

public static class PartyIdLocationId
{
    /// <summary>
    ...
    {
        return new string ((sbyte*)pointer, offset, PartyIdLocationId.Length).Trim();
    }
}
